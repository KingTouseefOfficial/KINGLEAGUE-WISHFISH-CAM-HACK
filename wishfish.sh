...
echo -e "\033[31m     \/  \/   |_|___/_| |_|\e[0m|_|    |_|___/_| |_| KINGLEAGUE";

printf "\e[1;77m Facebook :- facebook.com/KingTouseefOfficial \e[0m \n"
printf "\e[1;77m v2.0 Coded By TOUSEEF ALI \e[0m \n"
